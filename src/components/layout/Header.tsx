...
const Header = () => {
  ...
  return <header className="py-2 px-2 sm:px-4 lg:px-6 w-full fixed top-0 z-50 bg-white border-b border-gray-100 transition-all duration-300">
      ...
      {/* Mobile menu */}
      {menuOpen && <div className="fixed inset-0 bg-black bg-opacity-95 z-50 flex flex-col p-6 sm:p-10 lg:hidden animate-fade-in">
          ...
          <nav className="flex flex-col items-start space-y-6 sm:space-y-8 mt-12 sm:mt-16">
            <Link to="/shop" className="text-lg sm:text-xl text-white uppercase tracking-widest hover:opacity-70 transition-opacity" onClick={() => setMenuOpen(false)}>
              Shop
            </Link>
            <Link to="/lookbook" className="text-lg sm:text-xl text-white uppercase tracking-widest hover:opacity-70 transition-opacity" onClick={() => setMenuOpen(false)}>
              SS25 Lookbook
            </Link>
            <Link to="/news" className="text-lg sm:text-xl text-white uppercase tracking-widest hover:opacity-70 transition-opacity" onClick={() => setMenuOpen(false)}>
              News
            </Link>
